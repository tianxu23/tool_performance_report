...
WHERE IMPRSN_DT between current_date - 32 and   current_date - 2 
...
WHERE click_dt  between current_date - 32 and   current_date - 2 
    AND ams_trans_rsn_cd = 0
GROUP BY 1, 2, 3, 4
HAVING click_all > 0
...
WHERE 1=1			
---AND AMS_TRANS_RSN_CD=0
AND CLICK_dt   between current_date - 32 -365 and   current_date - 2 
...
AND fam.CK_TRANS_DT  between  current_date - 32 and   current_date - 2 
...
where
TRANS_DT between  current_date - 32 and   current_date - 2 
group by 1,2,3,4
