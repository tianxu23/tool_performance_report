...
WHERE IMPRSN_DT between '2018-01-01' and   current_date - 2 
...
WHERE click_dt  between '2018-01-01' and   current_date - 2 
    AND ams_trans_rsn_cd = 0
GROUP BY 1, 2, 3, 4
HAVING click_all > 0
...
WHERE 1=1			
---AND AMS_TRANS_RSN_CD=0
AND CLICK_dt   between '2017-01-01'  and   current_date - 2 
...
AND fam.CK_TRANS_DT  between  '2018-01-01' and   current_date - 2 
...
where
TRANS_DT between  '2018-01-01' and   current_date - 2 
group by 1,2,3,4
...
--sel * from dtl_pb_tool where pblshr_id is null;
...
sel * from  prs_ams_v.AMS_TOOL_CATEG where ams_tool_id is null;
/*
SELECT
...
sel * from  p_tiansheng_t.tool_performance_clv2
where ams_tool_id =11006;
