...
WHERE IMPRSN_DT between '2018-04-11' and   '2018-04-20' 
...
WHERE click_dt  between '2018-04-11' and   '2018-04-20'
    AND ams_trans_rsn_cd = 0
GROUP BY 1, 2, 3, 4
HAVING click_all > 0
...
WHERE 1=1			
---AND AMS_TRANS_RSN_CD=0
AND CLICK_dt   between '2017-04-11' and   '2018-04-20'
...
AND fam.CK_TRANS_DT   between '2018-04-11' and   '2018-04-20'
...
where
TRANS_DT  between '2018-04-11' and   '2018-04-20'
group by 1,2,3,4
...
delete from   p_tiansheng_t.tool_performance_clv2
where cal_DT between '2018-04-11' and '2018-04-20';   
...
sel distinct retail_wk_end_date from   p_tiansheng_t.tool_performance_summary_clv2;
