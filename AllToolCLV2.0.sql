...
WHERE IMPRSN_DT between '2018-03-16' and  current_date 
...
WHERE click_dt between '2018-03-16' and  current_date 
    AND ams_trans_rsn_cd = 0
GROUP BY 1, 2, 3, 4
HAVING click_all > 0
...
,b.IMPRSN_DT AS cal_dt
,b.ams_prgrm_id
,b.pblshr_id
,b.AMS_TOOL_ID
,COALESCE(a.click_mobile, 0) AS click_mobilej
...
WHERE 1=1			
---AND AMS_TRANS_RSN_CD=0
AND CLICK_dt between  '2018-03-16'  - 365  and  current_date  --- back to 1 year click
...
AND fam.CK_TRANS_DT  between  '2018-03-16' and  current_date 
...
where
TRANS_DT   between  '2018-03-16' and  current_date 
and
trfc_src_cd <> 0;
...
COLLECT STATISTICS COLUMN (AMS_TOOL_ID,AMS_PRGRM_ID,AMS_PBLSHR_ID) ON TRANS;  --zhege 
