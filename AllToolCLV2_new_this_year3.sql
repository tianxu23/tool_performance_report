...
WHERE 1=1			
---AND AMS_TRANS_RSN_CD=0
AND CLICK_dt   between '2017-04-21' and   current_date - 2 
...
AND fam.CK_TRANS_DT  between  '2018-04-21' and   current_date - 2 
...
where
TRANS_DT between  '2018-04-21' and   current_date - 2 
group by 1,2,3,4
